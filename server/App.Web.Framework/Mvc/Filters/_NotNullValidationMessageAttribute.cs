...
namespace App.Web.Framework.Mvc.Filters
{
    ...
    /// </summary>
    public sealed class _NotNullValidationMessageAttribute : TypeFilterAttribute
    {
        #region Ctor
        ...
        /// </summary>
        public _NotNullValidationMessageAttribute() : base(typeof(NotNullValidationMessageFilter))
        {
        }
