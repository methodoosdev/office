...
namespace App.Web.Framework.Mvc.Filters
{
    ...
    /// </summary>
    public sealed class _AuthorizeAdminAttribute : TypeFilterAttribute
    {
        #region Ctor
        ...
        public _AuthorizeAdminAttribute(bool ignore = false) : base(typeof(AuthorizeAdminFilter))
        {
            IgnoreFilter = ignore;
        ...
        private class AuthorizeAdminFilter : IAsyncAuthorizationFilter
        {
            ...
            private async Task AuthorizeAdminAsync(AuthorizationFilterContext context)
            {
                ...
                var actionFilter = context.ActionDescriptor.FilterDescriptors
                    ...
                    .OfType<_AuthorizeAdminAttribute>()
                    .FirstOrDefault();
