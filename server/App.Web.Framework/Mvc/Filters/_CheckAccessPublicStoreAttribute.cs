...
namespace App.Web.Framework.Mvc.Filters
{
    ...
    /// </summary>
    public sealed class _CheckAccessPublicStoreAttribute : TypeFilterAttribute
    {
        #region Ctor
        ...
        public _CheckAccessPublicStoreAttribute(bool ignore = false) : base(typeof(CheckAccessPublicStoreFilter))
        {
            IgnoreFilter = ignore;
        ...
        private class CheckAccessPublicStoreFilter : IAsyncAuthorizationFilter
        {
            ...
            private async Task CheckAccessPublicStoreAsync(AuthorizationFilterContext context)
            {
                ...
                var actionFilter = context.ActionDescriptor.FilterDescriptors
                    ...
                    .OfType<_CheckAccessPublicStoreAttribute>()
                    .FirstOrDefault();
