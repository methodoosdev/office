...
namespace App.Web.Framework.Mvc.Filters
{
    ...
    /// </summary>
    public sealed class _CheckLanguageSeoCodeAttribute : TypeFilterAttribute
    {
        #region Ctor
        ...
        public _CheckLanguageSeoCodeAttribute(bool ignore = false) : base(typeof(CheckLanguageSeoCodeFilter))
        {
            IgnoreFilter = ignore;
        ...
        private class CheckLanguageSeoCodeFilter : IAsyncActionFilter
        {
            ...
            private async Task CheckLanguageSeoCodeAsync(ActionExecutingContext context)
            {
                ...
                var actionFilter = context.ActionDescriptor.FilterDescriptors
                    ...
                    .OfType<_CheckLanguageSeoCodeAttribute>()
                    .FirstOrDefault();
