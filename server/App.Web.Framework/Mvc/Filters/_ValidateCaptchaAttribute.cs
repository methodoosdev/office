...
namespace App.Web.Framework.Mvc.Filters
{
    ...
    /// </summary>
    public sealed class _ValidateCaptchaAttribute : TypeFilterAttribute
    {
        #region Ctor
        ...
        public _ValidateCaptchaAttribute(string actionParameterName = "captchaValid") : base(typeof(ValidateCaptchaFilter))
        {
