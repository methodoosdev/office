...
namespace App.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        public virtual async Task<Employee> GetCurrentEmployeeAsync()
        {
            //whether there is a cached value
            ...
            //cache the found employee
            _cachedEmployee = employee;

            return _cachedEmployee;
        }

        public virtual async Task<Trader> GetCurrentTraderAsync()
        {
            //whether there is a cached value
            if (_cachedTrader != null)
                return _cachedTrader;
            ...
            if (trader == null || trader.Deleted || !trader.Active)
                return null;

            //cache the found employee
            _cachedTrader = trader;
