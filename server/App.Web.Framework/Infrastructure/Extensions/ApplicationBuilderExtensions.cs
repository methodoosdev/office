...
using App.Web.Framework.Globalization;
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static void StartEngine(this IApplicationBuilder application)
        {
            ...
            if (DataSettingsManager.IsDatabaseInstalled())
            {
                ...
                //update appCommerce core and db
        ...
        public static void UseNopStaticFiles(this IApplicationBuilder application)
        {
            ...
            application.UseStaticFiles(new StaticFileOptions
            {
                ...
                RequestPath = new PathString("/assets/server/db_backups"),
            ...
            application.UseStaticFiles(new StaticFileOptions
            {
                FileProvider = new PhysicalFileProvider(fileProvider.GetAbsolutePath("assets/server/icons")),
                RequestPath = "/assets/server/icons",
                ContentTypeProvider = provider
            });
            ...
            if (appSettings.Get<CommonConfig>().ServeUnknownFileTypes)
            {
                application.UseStaticFiles(new StaticFileOptions
                {
                    FileProvider = new PhysicalFileProvider(fileProvider.GetAbsolutePath("assets/server/.well-known")),
                    RequestPath = new PathString("/assets/server/.well-known"),
        ...
        public static void UseNopAuthentication(this IApplicationBuilder application)
        {
            ...
            //application.UseMiddleware<WebSocketsMiddleware>();
        ...
        public static void UseNopEndpoints(this IApplicationBuilder application)
        {
            ...
            //    await context.Response.SendFileAsync(Path.Combine(webHostEnvironment.WebRootPath, "index.html"));
            //});
        }
