...
namespace App.Web.Framework.Security
{
    /// <summary>
    ...
    public static class FilePermissionHelper
    {
        ...
        public static IEnumerable<string> GetDirectoriesWrite(this INopFileProvider fileProvider)
        {
            ...
            var dirsToCheck = new List<string>
            {
                ...
                fileProvider.Combine(rootDir, @"wwwroot\assets\server\bundles"),
                fileProvider.Combine(rootDir, @"wwwroot\assets\server\db_backups"),
                fileProvider.Combine(rootDir, @"wwwroot\assets\server\files\exportimport"),
                fileProvider.Combine(rootDir, @"wwwroot\assets\server\icons"),
                fileProvider.Combine(rootDir, @"wwwroot\assets\server\images"),
                fileProvider.Combine(rootDir, @"wwwroot\assets\server\images\thumbs"),
                fileProvider.Combine(rootDir, @"wwwroot\assets\server\images\uploaded")
            };
