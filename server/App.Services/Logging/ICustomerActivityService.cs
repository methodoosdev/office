...
namespace App.Services.Logging
{
    ...
    public partial interface ICustomerActivityService
    {
        ...
        Task<ActivityLog> InsertActivityOnceAsync(ActivityLogTypeType systemKeyword, string comment = null, BaseEntity entity = null);
        /// <summary>
        ...
        /// </returns>
        Task<ActivityLog> InsertActivityAsync(ActivityLogTypeType systemKeyword, string comment = null, BaseEntity entity = null);
        ...
        /// The task result contains the activity log item
        /// </returns>
        Task<ActivityLog> InsertActivityAsync(Customer customer, ActivityLogTypeType systemKeyword, string comment, BaseEntity entity = null);
        ...
        Task DeleteActivityAsync(IList<ActivityLog> activityLogs);
        /// <summary>
        ...
        Task<IList<ActivityLog>> GetActivitiesByIdsAsync(int[] activityLogIds);
        ...
        Task<IList<ActivityLog>> GetAllUserActivityAsync(DateTime fromDate, DateTime toDate);
        IQueryable<ActivityLog> Table { get; }
    }
}
