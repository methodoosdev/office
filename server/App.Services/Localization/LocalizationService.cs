...
namespace App.Services.Localization
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
            ...
            bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false)
        {
            ...
            if (workingLanguage != null)
                return await GetResourceAsync(resourceKey, workingLanguage.Id, logIfNotFound, defaultValue, returnEmptyIfNotFound);
        ...
        public virtual async Task<string> GetLocalizedEnumAsync<TEnum>(TEnum enumValue, int? languageId = null) where TEnum : struct
        {
            ...
            //localized value
            var workingLanguage = await _workContext.GetWorkingLanguageAsync();
            var resourceName = $"{NopLocalizationDefaults.EnumLocaleStringResourcesPrefix}{typeof(TEnum).Name}.{enumValue}";
        ...
        public virtual async Task<string> GetLocalizedCustomerPermissionNameAsync(CustomerPermission permission, int? languageId = null)
        {
            if (permission == null)
            ...
            //localized value
            var workingLanguage = await _workContext.GetWorkingLanguageAsync();
            var resourceName = $"{NopLocalizationDefaults.CustomerPermissionLocaleStringResourcesPrefix}{permission.SystemName}";
            var result = await GetResourceAsync(resourceName, languageId ?? workingLanguage.Id, false, string.Empty, true);
