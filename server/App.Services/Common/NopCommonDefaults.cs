...
namespace App.Services.Common
{
    ...
    public static partial class NopCommonDefaults
    {
        ...
        /// </summary>
        public static string DbBackupsPath => "assets\\server\\db_backups\\";
        ...
        /// </summary>
        public static string LocalePatternPath => "assets/server/lib_npm/cldr-data/main/{0}";
        ...
        /// </summary>
        public static string DefaultLanguageCulture => "el-GR";
        ...
        #region appCommerce official site

        /// <summary>
        /// Gets a path to request the appCommerce official site for license compliance check
        /// </summary>
        /// <remarks>
        /// {0} : store URL
        /// {1} : appCommerce version
        /// {2} : admin email
        /// {3} : language code
        /// </remarks>
        ...
        /// <summary>
        /// Gets a path to request the appCommerce official site for news RSS
        /// </summary>
        /// <remarks>
        /// {0} : appCommerce version
        /// {1} : whether the store based is on the localhost
        /// {2} : whether advertisements are hidden
        /// {3} : store URL
        /// {4} : language code
        /// </remarks>
        public static string NopNewsRssPath => "appCommerce-news-rss?version={0}&localhost={1}&hideAdvertisements={2}&storeUrl={3}&language={4}";

        /// <summary>
        /// Gets a path to request the appCommerce official site to notify about successful installation
        /// </summary>
        /// <remarks>
        /// {0} : appCommerce version
        /// {1} : whether the store based is on the localhost
        ...
        /// <summary>
        /// Gets a path to request the appCommerce official site for available categories of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        ...
        /// <summary>
        /// Gets a path to request the appCommerce official site for available versions of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        ...
        /// <summary>
        /// Gets a path to request the appCommerce official site for marketplace extensions
        /// </summary>
        /// <remarks>
