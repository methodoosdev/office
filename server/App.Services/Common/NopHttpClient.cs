...
{
    /// <summary>
    /// Represents the HTTP client to request appCommerce official site
    /// </summary>
    public partial class NopHttpClient
    {
        ...
        {
            //configure client
            client.BaseAddress = new Uri("https://www.appCommerce.com/");
            client.Timeout = TimeSpan.FromSeconds(5);
            client.DefaultRequestHeaders.Add(HeaderNames.UserAgent, $"appCommerce-{NopVersion.CURRENT_VERSION}");
