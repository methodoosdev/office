...
namespace App.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        IQueryable<CustomerRole> CustomerRoleTable { get; }
        Task<IList<Customer>> GetRegisterCustomersAsync();
        ...
        IQueryable<Customer> GetAllCustomersByRoles(int[] customerRoleIds = null);
        ...
        /// The task result contains the result
        /// </returns>
        Task<bool> IsOfficeAsync(Customer customer, bool onlyActiveCustomerRoles = true);
        Task<bool> IsEmployeeAsync(Customer customer, bool onlyActiveCustomerRoles = true);
        Task<bool> IsTraderAsync(Customer customer, bool onlyActiveCustomerRoles = true);
