...
{
    public class TekaSubmissionPage : UserHasMessagesPage
    {
        private readonly string _efkaLoginPage = "https://apps.e-efka.gov.gr/eAccess/login.xhtml";
        private readonly string _efkaHomePage = "https://apps.e-efka.gov.gr/eAPDssoTEKA/faces/secureAll/index.xhtml";
        private readonly string _efkaSubmissionsPage = "https://apps.e-efka.gov.gr/eAPDssoTEKA/faces/secureAdmin/submissions.xhtml";
        ...
        public TekaSubmissionPage(string connectionId) : base(connectionId: connectionId, emulateBrowserEnable: false, headless: false)
        {
            ...
            _apdButtonLocator = Page.Locator("//html/body/div[1]/div/div/div[2]/table[8]/tbody/tr/td[2]/a");
        ...
        public async Task<ApdSubmissionDto> Execute(int month, int year)
        {
            ...
            for (int i = currentPage; i <= allPages; i++)
            {
                ...
                var rows = await GetRowsSortedByDateColumnAsync(Page, "[id='submissionTable_data']", 2);
