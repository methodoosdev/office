...
namespace App.Core.Infrastructure
{
    ...
    public partial class CommonHelper
    {
        ...
        public static string SrfDecrypt(string cipherString, bool useHashing = true)
        {
        ...
        public static bool IsLetterOrDigit(string value)
        {
            ...
            bool match = Regex.IsMatch(value, "^[A-Z0-9]*$");
        ...
        public static bool IsLetter(string value)
        {
            ...
            bool match = Regex.IsMatch(value, "^[A-Z]*$");
