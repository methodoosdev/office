...
{
    public class MonthlyFinancialBulletinAccountingCodeDebitQuery : TraderFactoryQuery
    {
        public MonthlyFinancialBulletinAccountingCodeDebitQuery(int logistikiProgramTypeId, int categoryBookTypeId) : base(logistikiProgramTypeId, categoryBookTypeId)
        {
        }
