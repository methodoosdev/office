...
{
    public class ExpirationInventoryQuery : TraderFactoryQuery
    {
        public ExpirationInventoryQuery(int logistikiProgramTypeId, int categoryBookTypeId) : base(logistikiProgramTypeId, categoryBookTypeId)
        {
        }
