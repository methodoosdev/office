...
{
    public partial class NbgTransactionsController : BaseProtectController
    {
        ...
        public NbgTransactionsController(
        ...
        {
            var api = new NbgApiClient(false);

            await api.AuthenticateAsync();

            var x1 = await api.GetAvailableBanksAsync();

            var x2 = await api.GetUserIdAsync();

            return Json(new { x1, x2 });
        }
