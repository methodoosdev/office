...
namespace App.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetPlaywrightUrl(HttpRequest req)
        {
            var isLocalhost = IsLocalRequest(req);
            return isLocalhost ? "https://localhost:7170" : "https://playwright-01.serefidis.local";
            //return isLocalhost ? "http://localhost:5232" : "http://playwright-01.serefidis.local";
        }
