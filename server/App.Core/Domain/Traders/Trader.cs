...
{
    public partial class Trader : BaseEntity, ISoftDeletedEntity
	{
		// Προσωπικά στοιχεία
		...
		{
			get => (ActivatedType)ActivatedTypeId;
			set => ActivatedTypeId = (int)value;
		}
		...
		{
			get => (StatusType)StatusTypeId;
			set => StatusTypeId = (int)value;
		}
		...
		public FarmerType FarmerType
		{
			get => (FarmerType)FarmerTypeId;
			set => FarmerTypeId = (int)value;
		}
		...
		public CategoryBookType CategoryBookType
		{
			get => (CategoryBookType)CategoryBookTypeId;
			set => CategoryBookTypeId = (int)value;
		}
		...
		{
			get => (LegalFormType)LegalFormTypeId;
			set => LegalFormTypeId = (int)value;
		}

		public int VatSystemTypeId { get; set; } // ISNULL(P.F_REGIME_VAT, 0) AS VatSystemTypeId, -- Καθεστώς ΦΠΑ i
		public VatSystemType VatSystemType
		{
			get => (VatSystemType)VatSystemTypeId;
			set => VatSystemTypeId = (int)value;
		}
		...
		public EmploymentLevelType EmploymentLevelType
		{
			get => (EmploymentLevelType)EmploymentLevelTypeId;
			set => EmploymentLevelTypeId = (int)value;
		}

		public int ProfessionTypeId { get; set; }//F_JOB - Άσκηση επαγγελμα
        public ProfessionType ProfessionType
        {
            get => (ProfessionType)ProfessionTypeId;
            set => ProfessionTypeId = (int)value;
        }

        public int AccountingPlanTypeId { get; set; }
        public AccountingPlanType AccountingPlanType
        {
            get => (AccountingPlanType)AccountingPlanTypeId;
            set => AccountingPlanTypeId = (int)value;
        }

        public int PopulationTypeId { get; set; }
        public PopulationType PopulationType
        {
            get => (PopulationType)PopulationTypeId;
            set => PopulationTypeId = (int)value;
        }
        ...
        public LogistikiProgramType LogistikiProgramType
        {
            get => (LogistikiProgramType)LogistikiProgramTypeId;
            set => LogistikiProgramTypeId = (int)value;
        }
        public int PayrollProgramTypeId { get; set; } // Πρόγραμμα μισθοδοσίας
        public PayrollProgramType PayrollProgramType
        {
            get => (PayrollProgramType)PayrollProgramTypeId;
            set => PayrollProgramTypeId = (int)value;
        }
		...
		public int ParentId { get; set; } // Φυσικά πρόσωπα
