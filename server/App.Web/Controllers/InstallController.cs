...
using App.Web.Framework.Security;
...
namespace App.Web.Controllers
{
    ...
    public partial class InstallController : Controller
    {
        ...
        public virtual IActionResult Index()
        {
            ...
            {
                AdminEmail = "panos@admin.gr",
                AdminPassword = "1967",
                ConfirmPassword = "1967",
                ...
                DatabaseName = "DemoApp3",
                ServerName = "172.16.9.51,1433",
                Username = "srfdev",
                Password = "zmO2igJQPnb757zM",
                Country = "el-GR"
            };
