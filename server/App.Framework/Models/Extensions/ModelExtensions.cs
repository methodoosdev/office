...
namespace App.Framework.Models.Extensions
{
    /// <summary>
    ...
    public static class ModelExtensions
    {
        ...
        public static TListModel PrepareToGrid<TListModel, TModel>(this TListModel listModel,
            BaseSearchModel searchModel, IPagedList<TModel> objectList)
            where TListModel : BasePagedListModel<TModel>
            where TModel : BaseNopModel
        {
            if (listModel == null)
            ...
            listModel.Data = objectList.ToList();
            listModel.Draw = searchModel?.Draw;
            listModel.RecordsTotal = objectList?.TotalCount ?? 0;
            listModel.RecordsFiltered = objectList?.TotalCount ?? 0;
