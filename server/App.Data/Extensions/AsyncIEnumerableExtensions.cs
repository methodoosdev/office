...
namespace System.Linq
{
    ...
    {
        public static IOrderedAsyncEnumerable<TSource> OrderByAsync<TSource>(this IAsyncEnumerable<TSource> source, string param, string dir)
        {
        ...
        public static IOrderedAsyncEnumerable<TSource> ThenByByAsync<TSource>(this IOrderedAsyncEnumerable<TSource> source, string param, string dir)
        {
            var propertyInfo = typeof(TSource).GetProperty(param);
            return (dir == "desc")
        ...
        public static async Task<IPagedList<T>> ToPagedListAsync<T>(this IAsyncEnumerable<T> source, int pageIndex, int pageSize, bool getOnlyTotalCount = false)
        {
            if (source == null)
