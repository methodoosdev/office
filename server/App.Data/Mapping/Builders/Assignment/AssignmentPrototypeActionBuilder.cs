...
namespace App.Data.Mapping.Builders.Assignment
{
    ...
    /// </summary>
    public partial class AssignmentPrototypeActionBuilder : NopEntityBuilder<AssignmentPrototypeAction>
    {
        #region Methods
        ...
        {
            table
                .WithColumn(nameof(AssignmentPrototypeAction.Name)).AsString(255).NotNullable()
