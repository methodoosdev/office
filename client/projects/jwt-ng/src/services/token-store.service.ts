...
export class TokenStoreService {
    ...
    constructor(
        ...
        private utilsService: JwtUtilsService) { }
    ...
    storeLoginSession(response: any): void {
        this.setToken(AuthTokenType.AccessToken, response[ApiConfig.AccessTokenObjectKey]);
        this.setToken(AuthTokenType.RefreshToken, response[ApiConfig.RefreshTokenObjectKey]);
    }
