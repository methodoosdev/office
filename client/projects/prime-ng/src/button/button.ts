...
import { PrimeTemplate, PrimeSharedModule } from '../api/shared';
import { DomHandler } from '../dom/domhandler';
import { SpinnerIcon } from '../icons/spinner/spinner';
...
@NgModule({
    imports: [CommonModule, RippleModule, PrimeSharedModule, SpinnerIcon],
    exports: [ButtonDirective, Button, PrimeSharedModule],
