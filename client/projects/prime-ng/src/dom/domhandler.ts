...
export class DomHandler {
    ...
    public static relativePosition(element: HTMLElement, target: any): void {
        const getClosestRelativeElement = (el: any) => {
            if (!el) return;
    ...
    public static scrollInView(container: Element, item: Element) {
