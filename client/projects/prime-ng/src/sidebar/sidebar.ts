...
import { PrimeNGConfig, PrimeTemplate, PrimeSharedModule } from '../api/public_api';
import { DomHandler } from '../dom/domhandler';
import { TimesIcon } from '../icons/times/times';
import { RippleModule } from '../ripple/ripple';
import { Nullable, VoidListener } from '../ts-helpers/ts-helpers';
...
@NgModule({
    imports: [CommonModule, RippleModule, PrimeSharedModule, TimesIcon],
    exports: [Sidebar, PrimeSharedModule],
