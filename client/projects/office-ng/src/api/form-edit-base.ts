...
import { PrimeNGConfig, stateAnimation } from "@primeNg";
...
export class FormEditBaseComponent implements OnInit, CanComponentDeactivate {
    @ViewChild('editForm', { static: false }) editForm!: NgForm;
    animate: boolean = true;
    parentUrl: string;
    borderForm: boolean = true;
    horizontal: boolean = true;
    customButtonVisible: boolean = false;
    saveButtonVisible: boolean = true;
    saveAndExitButtonVisible: boolean = true;
    cancelButtonVisible: boolean = true;
    customButtonTheme: ButtonThemeColor = "tertiary";
