...
import { IntertemporalBUnitOfWork } from '@officeNg';
...
@Component({
    selector: "intertemporal-b",
    templateUrl: "./intertemporal-b.html",
...
export class IntertemporalBComponent implements OnInit {
    ...
    constructor(
        ...
        private uow: IntertemporalBUnitOfWork,
