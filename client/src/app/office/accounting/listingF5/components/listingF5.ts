...
import { ListingF5UnitOfWork } from "@officeNg";

@Component({
    selector: "listingF5",
    templateUrl: "./listingF5.html",
...
export class ListingF5Component implements OnInit, OnDestroy {
    excelFileName: string = 'listingF5.xlsx';
    ...
    constructor(
        ...
        private uow: ListingF5UnitOfWork,
        ...
        this.title = this.translationService.translate('title.listingF5');
