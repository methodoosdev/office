...
export class ProgressHubService {
    _options: signalR.IHttpConnectionOptions = {
    ...
    private hubName = "hubs/progress";

    //private message: Subject<any> = new Subject<any>();
    //public message$ = this.message.asObservable();

    private progress: Subject<string> = new Subject<string>();
    ...
    constructor(
        ...
        this.baseUrl = isLocalhost ? "https://localhost:7170/" : "https://playwright-01.serefidis.local/";
        //this.baseUrl = isLocalhost ? "http://localhost:5232/" : "http://playwright-01.serefidis.local/";
    }
    ...
    public addProgressLabelListener = () => {
        this.hubConnection.on('progressLabel', (message: string) => {
